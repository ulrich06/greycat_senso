 ...
 */
public class SmartCampusNode extends AbstractNode {
    ...
    public static class SmartCampusFactory implements NodeFactory {
        @Override
        public String name() {
            return NAME;
        }
        ...
        public Node create(long world, long time, long id, Graph graph, long[] initialResolution) {
            return new SmartCampusNode(world, time, id, graph, initialResolution);
        }
    }
}
